...
const Footer = () => {
    return (
        <footer className="px-12 lg:px-12 bg-gray-50 py-10 lg:py-10 border border-t border-gray-200">
            <div className="container mx-auto flex flex-wrap justify-between text-gray-950">
                {/* First Column */}
                <div className="footer-column lg:w-1/4 sm:w-1 pr-1">
                    <div className="flex items-center mt-4">
                        <Link to="/" className="font-bold text-xl">Food Delivery App
                        </Link>
                    </div>
                    <p className="text-large mt-2 text-gray-700 ">
                        Delicious food delivered to your doorstep asap!
                    </p>
                </div>
                {/* Second Column */}
                <div className="footer-column lg:w-1/4 ">
