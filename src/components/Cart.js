...
const Cart = () => {
    return (<div>
        ...
        <div className="px-30 flex flex-col justify-center items-center bg-slate-50 p-20">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-1">
                    <div className="bg-white px-6 py-8 shadow-md">
                        ...
                        <Link className="underline text-black font-bold py-4 px-6 mt-2 mr-2">
                            Login / Register
                        </Link>
                ...
                <div className=" text-gray-800 ">
                    <section aria-labelledby="summary-heading" className="flex shadow-md flex-col p-6 bg-white">
                        ...
                        <div className="mt-6">
                            <button type="submit" className="bg-gray-950 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-full">
                                Checkout
                            </button>
                        </div>
                    </section>
